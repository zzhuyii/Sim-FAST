...
function Plot_Shape_Bar_Failure(obj,passYN)
...
for j=1:actBarNum
    node1=node0(actBarConnect(j,1),:);
    node2=node0(actBarConnect(j,2),:);
    line([node1(1),node2(1)],...
         [node1(2),node2(2)],...
         [node1(3),node2(3)],'Color',[0.5 0.5 0.5],'Linewidth',0.5);
end

%% color code bar based on passYN
